  ...
  try {
      ...
      <div className="space-y-6">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Select
                  defaultValue={securityConfig.maxLoginAttempts.toString()}
                >
                  <SelectTrigger className="w-32">
                    <SelectValue />
                  </SelectTrigger>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage administrative privileges and promote users to admin
            </CardDescription>
          </CardHeader>
          <CardContent>
            <AdminManagement />
    ...
    return (
      <Alert>
        <AlertTriangle className="h-4 w-4" />
        <AlertDescription>
          Failed to load security information. Please check your admin
