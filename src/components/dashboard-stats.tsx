...
import { TrendingUp, TrendingDown, DollarSign, CreditCard, AlertCircle, Calendar } from "lucide-react"
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      {stats.unusedSubscriptions && stats.unusedSubscriptions > 0 && (
        <Card className="md:col-span-2 lg:col-span-4 border-yellow-200 bg-yellow-50/50 dark:border-yellow-900 dark:bg-yellow-900/10">
