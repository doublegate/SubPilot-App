    ...
    try {
      ...
      if (scenario < 0.75) {
        ...
        return {
          ...
          error: {
            code: "PROVIDER_ERROR",
            message: "You have multiple Amazon subscriptions. Please specify which one to cancel or visit Amazon's subscription management page.",
          },
        };
        ...
        return {
          ...
          error: {
            ...
            message: "Amazon requires two-factor authentication for this action. Please complete 2FA on Amazon's website.",
          },
        };
      } else {
        // Account hold
        return {
          ...
          error: {
            code: "PROVIDER_ERROR",
            message: "Your Amazon account has pending charges or orders. Please resolve these before cancelling subscriptions.",
          },
        };
      }
    } catch (error) {
