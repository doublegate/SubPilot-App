...
export class ManualCancellationProvider implements CancellationProvider {
  ...
  async cancel(
    ...
    return {
      ...
      error: {
        ...
        message:
          'This subscription requires manual cancellation. Please follow the provided instructions.',
      },
    };
  }
   ...
   */
  private parseProviderInstructions(
    provider: any,
    subscription: any
  ): ManualInstructionSet {
    const instructions: ManualInstruction[] = provider.instructions.map(
      (instr: any, index: number) => ({
        step: index + 1,
    ...
    const instructions: ManualInstruction[] = [
      {
        ...
        description:
          'Gather your account details including username, email, and any account numbers associated with your subscription.',
      ...
      },
      {
        ...
        warning:
          "Make sure you're on the official website to avoid phishing attempts.",
      },
      {
        step: 3,
        title: 'Navigate to account settings',
        description:
          "Look for 'Account', 'Settings', 'Billing', or 'Subscription' in the menu. This is typically found in the top-right corner after logging in.",
      ...
      },
      {
        ...
        description:
          "Look for options like 'Cancel Subscription', 'End Membership', or 'Turn off Auto-Renewal'.",
        warning:
          'Some providers hide this option. You may need to click through multiple pages.',
        alternativeMethod: {
          step: 4,
          title: 'Contact customer support',
          description:
            'If you cannot find the cancellation option, use the contact information below to reach customer support directly.',
      ...
      },
      {
        ...
        description:
          'Follow the cancellation flow. You may be asked to provide a reason or offered incentives to stay.',
        warning:
          "Read carefully - some providers only offer to 'pause' rather than cancel.",
      ...
      },
      {
        ...
        description:
          'Once cancelled, save or screenshot the confirmation page and any confirmation number provided.',
        expectedResult:
          'You should receive a confirmation number and/or email confirming your cancellation.',
        warning:
          "If you don't receive confirmation immediately, contact support to verify the cancellation.",
      },
    ];
      ...
      commonIssues: [
        {
          ...
          solution:
            "Try searching 'cancel' in the help section or contact support directly",
        },
        {
          issue: 'Website asks me to call',
          solution:
            'Some providers require phone cancellation. Call during business hours for shorter wait times',
        },
        {
          issue: 'Offered a discount to stay',
          solution:
            'If you want to cancel, politely decline and proceed. If the offer is good, you can always resubscribe later',
        },
        {
          issue: 'Cancellation not processed',
          solution:
            'Contact support with your confirmation number. If needed, dispute charges with your bank',
        },
      ],
    };
  }
  ...
  private getProviderTips(provider: any): string[] {
    ...
    if (provider.requiresRetention) {
      tips.push(
        "Be prepared to decline retention offers if you're sure about cancelling"
      );
    }
  ...
  private getCommonIssues(
    ...
    if (provider.requiresRetention) {
      issues.push({
        ...
        solution:
          'Politely but firmly state you want to cancel. You can always resubscribe later if needed',
      });
    }
