...
class CancellationEventBus extends EventEmitter {
   ...
   */
  public onCancellationEvent(eventType: string, listener: (data: any) => void): void {
   ...
   */
  public onceCancellationEvent(eventType: string, listener: (data: any) => void): void {
   ...
   */
  public offCancellationEvent(eventType: string, listener: (data: any) => void): void {
...
export function onCancellationEvent(eventType: string, listener: (data: any) => void): void {
  eventBus.onCancellationEvent(eventType, listener);
}

export function onceCancellationEvent(eventType: string, listener: (data: any) => void): void {
  eventBus.onceCancellationEvent(eventType, listener);
}

export function offCancellationEvent(eventType: string, listener: (data: any) => void): void {
...
export type CancellationEventType = typeof CancellationEventTypes[keyof typeof CancellationEventTypes];